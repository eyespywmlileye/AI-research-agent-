...
researcher = GPTAssistantAgent(
    ...
    llm_config = {
        ...
        "assistant_id": "asst_LPCSKAsnEav7qGeNSL8kHnQf"
    }
)
...
research_manager = GPTAssistantAgent(
    ...
    llm_config = {
        "config_list": config_list,
        "assistant_id": "asst_dTKm6rC5HH1CDkJ9ejvTdXgp"
    }
)
...
director = GPTAssistantAgent(
    ...
    llm_config = {
        "config_list": config_list,
        "assistant_id": "asst_JR284LHIqJoq7onlXrw4KnmX",
    }
)
...
# ------------------ start conversation ------------------ #
message = """
Research the funding stage/amount & pricing for each company in the list: https://airtable.com/appL9mTbmOnK6zVaR/tblo9KgVq39HXUOnV/viwHmW27D328BVSkc?blocks=hide
"""
